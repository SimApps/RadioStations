...
import com.amirami.simapp.downloader.core.database.DownloaderDao
import com.amirami.simapp.downloader.core.model.DownloaderData
import com.amirami.simapp.downloader.core.model.StatusModel
import com.amirami.simapp.downloader.helper.ConnectionHelper
import com.amirami.simapp.downloader.helper.MimeHelper
            ...
            async {
                ...
                try {
                    ...
                    val fileOutputStream =
                        if (downloadedSize == 0) withContext(Dispatchers.IO) {
                            FileOutputStream(downloadedFile)
                        }
                        else withContext(Dispatchers.IO) {
                            FileOutputStream(downloadedFile, true)
                        }
                    ...
                    while (withContext(Dispatchers.IO) {
                     ...
                     //       Pair(false, IllegalStateException("Please check your network!"))
                     //   }
