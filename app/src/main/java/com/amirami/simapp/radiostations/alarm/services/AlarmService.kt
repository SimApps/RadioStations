...
import com.amirami.simapp.radiostations.alarm.ui.activities.RingActivity
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (intent?.action) {
            ...
            Constants.SNOOZE_SERVICE -> {
                ...
                val pStopIntent = PendingIntent.getService(this, 100, stopIntent, flag)

                val snoozeIntent = Intent(this, AlarmService::class.java).apply {
                    action = Constants.SNOOZE_SERVICE
                }
                val pSnoozeIntent = PendingIntent.getService(this, 100, snoozeIntent, flag)
